      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 border border-slate-200 rounded-xl shadow-lg">
        ...
        {success ? (
          <div className="bg-emerald-50 border-l-4 border-emerald-500 p-4 rounded-md">
            ...
            <p className="text-sm text-emerald-700 mt-2">Redirecting to login in 5 seconds...</p>
          </div>
        ) : (
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="text" required
                  className="appearance-none block w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm mt-1"
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2 pr-10 border border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm"
